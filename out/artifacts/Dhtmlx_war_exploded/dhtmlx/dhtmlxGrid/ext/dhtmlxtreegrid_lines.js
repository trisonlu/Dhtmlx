...
*/
dhtmlXGridObject._emptyLineImg="line";dhtmlXGridObject.prototype._updateTGRState=function(z,force){if (force || !z.update || z.id==0)return;this._updateLine(z,this.rowsAr[z.id]);z.update=false};dhtmlXGridObject.prototype._updateLine=function(z,row){row=row||this.rowsAr[z.id];if (!row)return;var im=row.imgTag;if (!im)return;if (z.state=="blank")return im.src=this.imgURL+"blank.gif";var n=1;if (z.index==0){if (z.level==0){if ((z.parent.childs.length-1)>z.index)
 n=3;else n=1}else
