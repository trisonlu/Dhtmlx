...
dhtmlXGridCellObject.prototype.setValueByHtml = function(val) {
	this.cell.innerHTML = val;
}
function eXcell_html(cell) {
	if (cell) {
		this.cell = cell;
		this.grid = this.cell.parentNode.grid;
	}
}
eXcell_html.prototype = new eXcell;
eXcell_html.prototype.setValue = function(val) {
	var obj = this;
	this.innerHTML = val;
}
